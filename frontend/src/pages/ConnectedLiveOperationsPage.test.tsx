...
function stubFetch(options: { frames?: string[]; lateFrames?: string[]; timelinePages?: unknown[]; timelineDelays?: number[]; devicePages?: Record<string, unknown>[][]; sessionIdSwitches?: boolean; eventHold?: Promise<unknown>; alertHold?: Promise<unknown>; deviceHold?: Promise<unknown>; metricsHold?: Promise<unknown>; eventFails?: boolean; alertFails?: boolean; failAll?: boolean } = {}) {
